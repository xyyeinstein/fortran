...
subroutine setMolecules_square()
  ...
  if(group=='C2v'.or.group=='D2h')then; call setMolecules_LowSymmetry(); return; end if
...
subroutine setMolecules_LowSymmetry()
  ...
  !notice: In low symmetry groups C2v and D2h, all representations are one-dimensional: A1g, B2g, E1u, E2u. 
